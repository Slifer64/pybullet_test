...
def two_layer_model(X, Y, layers_dims, learning_rate = 0.0075, num_iterations = 3000, print_cost=False):
    ...
    net.W[1] = parameters["W1"]
    net.b[1] = parameters["b1"]
    net.W[2] = parameters["W2"]
    net.b[2] = parameters["b2"]
    # YOUR CODE ENDS HERE
...
#         grads['db2'] = db2
        ...
        # parameters = ...
        # YOUR CODE STARTS HERE
        net.optimize_step(learning_rate)
...
#         b2 = parameters["b2"]
        ...
        parameters["W1"] = net.W[1]
        parameters["b1"] = net.b[1]
        parameters["W2"] = net.W[2]
        parameters["b2"] = net.b[2]
...
def L_layer_model(X, Y, layers_dims, learning_rate = 0.0075, num_iterations = 3000, print_cost=False):
    ...
    for l in range(1, L+1):
        net.W[l] = parameters['W' + str(l)]
        net.b[l] = parameters['b' + str(l)]
    # YOUR CODE ENDS HERE
    ...
    for i in range(0, num_iterations):
        ...
        net.optimize_step(learning_rate)
        for l in range(1, L+1):
            parameters['W' + str(l)] = net.W[l]
            parameters['b' + str(l)] = net.b[l]
